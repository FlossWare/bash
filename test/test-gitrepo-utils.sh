...
. `dirname ${BASH_SOURCE[0]}`/../src/gitrepo-utils.sh
. `dirname ${BASH_SOURCE[0]}`/../src/test-utils.sh
...
test-ensureProtocol() {
    ...
    assert-success ensureProtocol "https://github.com/FlossWare-archives/core.git" &&
    assert-success ensureProtocol "git@github.com:FlossWare-archives/core.git"  &&
...
test-convertProtocol() {
    ...
    assert-equals "git@github.com:FlossWare-archives/core.git" "`convertProtocol https://github.com/FlossWare-archives/core.git`" &&
    assert-equals "git@github.com:FlossWare-archives/core.git" "`convertProtocol git@github.com:FlossWare-archives/core.git`"  &&
...
test-convertGitRemote-github() {
    ...
    git clone https://github.com/FlossWare-archives/core.git
    cd core
    ...
    assert-equals "git@github.com:FlossWare-archives/core.git" "${REMOTE}"
}
